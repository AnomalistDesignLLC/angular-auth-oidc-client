...
Observable_1.Observable.interval = interval$3.interval;
...
Observable_1.Observable.throw = _throw$3._throw;
...
Observable_1.Observable.timer = timer$3.timer;
 ...
 * @owner Observable
 */
function _catch$3(selector) {
    return catchError_1.catchError(selector)(this);
}
var _catch_2 = _catch$3;
...
function auditTime$3(duration, scheduler) {
    if (scheduler === void 0) { scheduler = async.async; }
    return audit_1.audit(function () { return timer$3.timer(duration, scheduler); });
}
...
class AuthWellKnownEndpoints {
    /**
       ...
       */
    constructor(http$$1, authConfiguration, oidcSecurityCommon) {
        this.http = http$$1;
        this.authConfiguration = authConfiguration;
        this.oidcSecurityCommon = oidcSecurityCommon;
        /**
...
class OidcSecurityUserService {
    /**
       ...
       */
    constructor(http$$1, authConfiguration, oidcSecurityCommon, authWellKnownEndpoints) {
        this.http = http$$1;
        this.authConfiguration = authConfiguration;
        this.oidcSecurityCommon = oidcSecurityCommon;
        this.authWellKnownEndpoints = authWellKnownEndpoints;
...
class OidcSecurityService {
    /**
       ...
       */
    constructor(platformId, http$$1, authConfiguration, router$$1, oidcSecurityCheckSession, oidcSecuritySilentRenew, oidcSecurityUserService, oidcSecurityCommon, authWellKnownEndpoints) {
        ...
        /**
           ...
           * @memberof OidcSecurityService
           */
        this.source_mobile = Observable.timer(30000, 30000)
            .timeInterval()
            .pluck('interval')
            .take(10000);
        /**
           ...
           * @memberof OidcSecurityService
           */
        this.source_browser = Observable.timer(3000, 3000)
            .timeInterval()
            .pluck('interval')
            .take(10000);
    }
    ...
    /**
       ...
       * @memberof OidcSecurityService
       */
    authorize(authenticationScheme = 'local') {
        const data = this.oidcSecurityCommon.retrieve(this.oidcSecurityCommon.storage_well_known_endpoints);
        if (data && data !== '') {
            this.authWellKnownEndpointsLoaded = true;
        }
    ...
    /**
       ...
       * @memberof OidcSecurityService
       */
    authorizeWithPopup(authenticationScheme = 'local') {
    ...
    /**
       ...
       * @memberof OidcSecurityService
       */
    authorizeWithWebview(authenticationScheme = 'local') {
        this._popupFor = 'login';
        const data = this.oidcSecurityCommon.retrieve(this.oidcSecurityCommon.storage_well_known_endpoints);
        if (data && data !== '') {
            this.authWellKnownEndpointsLoaded = true;
    ...
    /**
       ...
       * @memberof OidcSecurityService
       */
    webview(url, target, options = 'location=yes,status=yes') {
        this.CheckForPopupClosedInterval = 2000;
    ...
    /**
       ...
       * @memberof OidcSecurityService
       */
    authorizedCallbackForWebview(result) {
                ...
                if (isRenewProcess) {
                    ...
                    this.oidcSecurityUserService.initUserData()
                        ...
                        if (this.oidcSecurityValidation.validate_userdata_sub_id_token(decoded_id_token.sub, this.oidcSecurityUserService.userData.sub)) {
                            ...
                            // some went wrong, userdata sub does not match that from id_token
    ...
    logoff() {
        return new Promise((resolve, reject) => {
            ...
            if (this.authWellKnownEndpoints.end_session_endpoint) {
                ...
                const url = authorizationEndsessionUrl + '?' +
                ...
                if (this.authConfiguration.start_checksession && this.checkSessionChanged) {
                    ...
                    this.oidcSecuritySilentRenew.silentLogout(url).then(res => {
                        resolve();
                    });
                }
            }
    ...
    refreshSession() {
        return new Promise((resolve, reject) => {
            ...
            this.oidcSecuritySilentRenew.startRenew(url).then(res => {
                resolve();
            }, err => {
                reject();
            });
    ...
    /**
       ...
       * @memberof OidcSecurityService
       */
    getAuthorizeData(nonce, state, authorization_endpoint) {
        return {
...
export { AuthModule, OidcSecurityService, OidcSecurityValidation, OidcSecurityCheckSession, OidcSecuritySilentRenew, OidcSecurityUserService, OidcSecurityCommon, OidcSecurityStorage, BrowserStorage, AuthWellKnownEndpoints, AuthConfiguration, OpenIDImplicitFlowConfiguration, DefaultConfiguration };
