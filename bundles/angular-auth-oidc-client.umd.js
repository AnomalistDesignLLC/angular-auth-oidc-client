(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/http'), require('@angular/common/http'), require('@angular/common'), require('@angular/router'), require('rxjs/Observable'), require('jsrsasign')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/http', '@angular/common/http', '@angular/common', '@angular/router', 'rxjs/Observable', 'jsrsasign'], factory) :
	(factory((global.angularAuthOidcClient = {}),global.ng.core,global.ng.http,global.ng.common.http,global.ng.common,global.ng.router,global.Rx,global.jsrsasign));
}(this, (function (exports,core,http,http$1,common,router,Observable,jsrsasign) { 'use strict';
...
var OidcDataService = (function () {
    ...
    OidcDataService.prototype.getWellknownEndpoints = function (url) {
        var headers = new http$1.HttpHeaders({ 'Accept': 'application/json' });
